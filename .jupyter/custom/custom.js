    ...
    macros: {
      Expecto: ["Macro", "\\mathop{\\mathbb{E}}"],
		  ...
		  bold: ["Macro","{\\bf #1}", 1],
			...
			checkmate: ["Macro", "\\quad\\color{#5cb85b}\\large\\unicode{x2713}"],
